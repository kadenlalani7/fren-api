...
class Config:
    ...
    HEADERS = {
                ...
                "authorization": "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJhZGRyZXNzIjoiMHgxZWM4YjNiNGNkMzAxZWM4MTllZDk5MjVhZmRmYmFlNmIxMmUzZjliIiwiaWF0IjoxNjk1MjM3OTI3LCJleHAiOjE2OTc4Mjk5Mjd9.-RBIxeEA-WPYGMLGoG9nNNYMhfsBCIt--Wk2cnoJKPU",
                "content-type": "application/json",
                "if-none-match": 'W/"43ee-SG3+95jbPXGKyz9HKH+tKnbmz6M"',
